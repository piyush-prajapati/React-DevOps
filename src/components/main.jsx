          ...
          <div className="row d-flex align-items-right">
            <div className="dropdown">
              <a
                ...
                aria-expanded="false"
              >
                <i className="fas fa-upload fa-md text-white-50"></i> Instant
                Deploy
              </a>
              <div
          ...
          <div className="col-xl-8 col-lg-7">
            <div className="card shadow mb-4">
              ...
              <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 className="m-0 font-weight-bold text-primary">Staging</h6>
              ...
              <div className="card-body">
                ...
                <div className="mt-4 text-center small">
                  <span className="mr-2" data-comps="70">
                    <i className="fas fa-circle text-primary"></i> Componets :{" "}
                    <span id="chart-components">0</span>
                  </span>
                  <span className="mr-2" data-profiles="90">
                    <i className="fas fa-circle text-success"></i> Profiles :{" "}
